package chapter5_strings.dataCompression;
...
public class Huffman {
    ...
    private static class Node implements Comparable<Node> {
        private final char ch;      //叶子节点 此节点代表char
        private final int freq;     //内部节点 叶子节点都有
        private final Node left, right; //叶子节点left right为空
