...
public class FordFulkerson {
    ...
    private boolean[] marked;     // marked[v] = true iff s->v path in residual graph       //剩余网络
    ...
    public FordFulkerson(FlowNetwork G, int s, int t) {
        ...
        // while there exists an augmenting path, use it        //存在增广路径  直到不存在为止
        value = excess(G, t);
    ...
    private boolean hasAugmentingPath(FlowNetwork G, int s, int t) {
        ...
        // is there an augmenting path?
        return marked[t];       //TODO false则意味着不存在到t的增广路径（在中途的路径有一条正向边饱和）
    }
...
//        StdOut.println(G);
        ...
        In in = new In("./chapter6_context/tinyFN.txt");
